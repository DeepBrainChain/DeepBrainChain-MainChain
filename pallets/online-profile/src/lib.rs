...
pub mod pallet {
    ...
    pub(super) type BondingQueue<T> =
        StorageValue<_, VecDeque<BondingPair<<T as frame_system::Config>::AccountId>>, ValueQuery>;
