...
pub fn compact_code_unwrap() -> &'static [u8] {
    dbc_runtime::WASM_BINARY.expect(
...
pub const SPEC_VERSION: u32 = dbc_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = dbc_runtime::VERSION.transaction_version;
